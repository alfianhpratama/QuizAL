...
abstract class $TopicStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DataStateStatus status, List<Topic> data});
}
...
class _$_TopicState implements _TopicState {
  ...
  @override
  String toString() {
    return 'TopicState(status: $status, data: $data)';
  }
...
abstract class _TopicState implements TopicState {
  const factory _TopicState(
      {final DataStateStatus status, final List<Topic> data}) = _$_TopicState;
